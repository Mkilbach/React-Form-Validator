...
function App() {
  return (
    <div className="App">
      <Input type={'radio'} id={'radio'} defaultValue={22} inputOptions={[[12, 22], 3, 4]} name={'test'} title={'radios'} />
      <div>
        <h2>
          Input
        </h2>
        <div>
          <Input id={'id'} name={'name'} max={7} checked={false} type={'checkbox'} title={'title'} rule={'select'} inputOptions={[[1, 2], 3, 4, [5, 6]]} required={true} errorText={'only numbers allowed'} />
        </div>
      </div>
      <div>
      ...
      <Input name="wrapper" required={true} name={'test'}>
        <h5>radio1</h5>
